export const itineraryData = [
    {
        ...
        stats: { budget: 528, kmWalked: 4.5, kmTraveled: 30 },
        activities: [
            ...
            { time: "09:30 - 10:15", title: "Hotel: BW Plus Sydney Opera", location: "8 Rue des Mathurins, 75009", description: "Store luggage at front desk. Hotel near Opéra/Madeleine, central Paris.", tip: "PRE PAID FOR 5 NIGHTS (€335/night). Check-in from 14:00, front desk holds luggage.", cost: 0, transit: "0.5 km by Walk (8m)", icon: "fa-bed", type: "hotel", info: { address: "8 Rue des Mathurins, 75009 Paris", hours: "24/7 Front Desk", tel: "+33 1 44 56 08 08", web: "bestwestern.fr", budget: "Pre-paid (€1,675 total)" } },
    ...
    },
    {
        ...
        stats: { budget: 550, kmWalked: 6.2, kmTraveled: 5 },
        activities: [
    ...
    },
    {
        ...
        stats: { budget: 530, kmWalked: 7.1, kmTraveled: 3 },
        activities: [
            { time: "09:00 - 13:00", title: "Louvre Museum", location: "Rue de Rivoli", description: "4 hours inside. Mona Lisa, Venus de Milo, Winged Victory.", tip: "Use the underground Carrousel du Louvre entrance for shorter security lines.", cost: 64, icon: "fa-landmark", type: "attraction", info: { address: "Rue de Rivoli, 75001 Paris", hours: "09:00 - 18:00 (Closed Tue)", tel: "+33 1 40 20 50 50", web: "louvre.fr", budget: "€64 for 2" } },
            { time: "13:30 - 14:30", title: "Lunch near Île de la Cité", location: "Île de la Cité", description: "Quick bite or crêpes near the islands to refuel.", tip: "Grab a quick crêpe on the go to maximize your afternoon sightseeing time.", cost: 40, transit: "Walk (10m)", icon: "fa-utensils", type: "meal", info: { address: "Île de la Cité area", hours: "12:00 - 15:00", tel: "N/A", web: "N/A", budget: "€40 Est. for 2" } },
            { time: "15:00 - 16:00", title: "Sainte-Chapelle", location: "8 Boulevard du Palais", description: "Breathtaking 13th-century Gothic chapel featuring 15 enormous stained glass windows.", tip: "Try to go when the sun is shining; the glass looks spectacular when backlit.", cost: 26, transit: "Walk (5m)", icon: "fa-church", type: "attraction", info: { address: "10 Bd du Palais, 75001 Paris", hours: "09:00 - 17:00", tel: "+33 1 53 40 60 80", web: "sainte-chapelle.fr", budget: "€26 for 2" } },
    ...
    },
    {
        ...
        stats: { budget: 543, kmWalked: 8.5, kmTraveled: 45 },
        activities: [
    ...
    },
    {
        ...
        stats: { budget: 473, kmWalked: 6.0, kmTraveled: 8 },
        activities: [
    ...
    },
    {
        ...
        stats: { budget: 275, kmWalked: 5.5, kmTraveled: 12 },
        activities: [
            { time: "09:00 - 09:45", title: "Hotel: Oden Paris Ivry", location: "Ivry-sur-Seine", description: "Check out of first hotel and relocate to new hotel outside Paris.", tip: "Take a taxi WITH your luggage since navigating the metro stairs with bags is tough. (€142/night)", cost: 25, transit: "Taxi (25m)", icon: "fa-bed", type: "hotel", info: { address: "Ivry-sur-Seine", hours: "24/7 Front Desk", tel: "+33 1 00 00 00 00", web: "N/A", budget: "Pre-paid (€568 total)" } },
    ...
    },
    {
        ...
        stats: { budget: 252, kmWalked: 6.0, kmTraveled: 155 },
        activities: [
    ...
    },
    {
        ...
        stats: { budget: 438, kmWalked: 7.2, kmTraveled: 6 },
        activities: [
    ...
    },
    {
        ...
        stats: { budget: 420, kmWalked: 6.8, kmTraveled: 10 },
        activities: [
    ...
    },
    {
        ...
        stats: { budget: 400, kmWalked: 0.5, kmTraveled: 35 },
        activities: [
            ...
            { time: "10:30 - 12:30", title: "Airport Duty Free Shopping", location: "CDG Terminal 2E", description: "Last minute shopping for luxury goods, French delicacies, and gifts.", tip: "VAT is already removed or claimed here. Great for perfume and spirits.", cost: 330, icon: "fa-bag-shopping", type: "neutral", info: { address: "CDG Duty Free Area", hours: "06:00 - Last Flight", tel: "N/A", web: "parisaeroport.fr", budget: "€330 Est." } },
            { time: "13:25 - 01:00", title: "Flight MU554 to Shanghai", location: "CDG Terminal 2E", description: "Direct flight back to Shanghai Pudong. Arrives 07:00 (+1 day). Safe travels!", tip: "Don't forget to claim any VAT refunds at the airport before you pass security.", cost: 0, transit: "Flight (11h 35m)", icon: "fa-plane-departure", type: "transit" }
        ]
    }
];
